...
abstract class Controller
{
    ...
    /** Implement index function in retrieved controllers.
     */
    ...
    */
    public function load_view($name, &$data = array(), $echo = True)
    {
        // Start output buffering.
        ob_start();

        // Execute the view and populate it with the data variables.
        $this->__load_view($view, $data);
     ...
     * @param data an array containing keys and values used inside the view.
     */
    private function __load_view($__view, &$__data)
    {
